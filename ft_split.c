...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/25 12:11:15 by ddidenko          #+#    #+#             */
/*   Updated: 2023/05/25 19:00:34 by ddidenko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	**get_string(char const *s, char c, int index, char **split)
{
	size_t	i;
	size_t	j;
...
//   int	main()
// {
// 	char **result = ft_split("hello! my friend", 32);
// 	if (result != NULL)
// 	{
